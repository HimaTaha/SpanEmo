...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        checkpoint_file_path = self.checkpoint_path + '/models/' + self.cur_date + '_checkpoint.pt'
        if self.verbose:
            print(
                f'Validation loss decreased ({self.val_loss_min:.6f} --> {val_loss:.6f}).  Saving model ... location : {checkpoint_file_path}')
